# `@sebastienrousseau/eslint-config` Features & Capabilities

An exhaustive overview covering **100% of the features, rules, and capabilities** provided by `@sebastienrousseau/eslint-config`.
...
| :--- | :--- | :--- | :--- |
| **ES2024 & Node.js Environments** | Core | Active | Configured for modern ECMAScript and Node.js runtimes |
